...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post tools_url, params: { tool: { diameter: @tool.diameter, length: @tool.length, quantity: @tool.quantity, tooltype: @tool.tooltype } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { diameter: @tool.diameter, length: @tool.length, quantity: @tool.quantity, tooltype: @tool.tooltype } }
